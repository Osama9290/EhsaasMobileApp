...
public class CompletedDeliver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userPreferences=new UserPreferences(CompletedDeliver.this);

        back.setOnClickListener(v -> finish());
        recyclerView=findViewById(R.id.recyclerview);
        delivery_text=findViewById(R.id.delivery_text);
        delivery_text.setText("Completed Deliveries");
        progress = new ProgressDialog(CompletedDeliver.this);
        ...
        db.collection("delivery")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        usedItemsAdapter groupAdapter = new usedItemsAdapter(requestsModels, CompletedDeliver.this);
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(CompletedDeliver.this);
